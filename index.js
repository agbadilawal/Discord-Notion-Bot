...
client.on("messageReactionAdd", (reaction, user) => {
  ...
  if (reaction.emoji.name === "✍️") {
    if (
      reaction.message.member.roles.cache.some((role) => role.name === "Admin")
    ) {
...
//install discord.js dependency{npm install discord.js}
//install dotenv dependency{npm i dotenv}
//install notion dependency{npm install @notionhq/client}
